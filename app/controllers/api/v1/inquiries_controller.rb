class Api::V1::InquiriesController < ApplicationController
  ...
  def create  
    ...
    inquiry.update_attribute('status', 'received')
  ...
  private
    ...
    def inquiry_params
      params.permit(:first_name, :last_name, :company_name, :email, :phone_number, :zip_code, :product, :material, :color, :length, :width, :quantity, :lead_time, :in_hand_date, :comment, :application, :source, :new_lead, :registered, :subscribed, :ribbon_type, :bow_size, :bow_loop_type, :metal_end_type, :attachment)
    end
end